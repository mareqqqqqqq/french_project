// Top header with score + progress + auth
function Header({ score, step, totalSteps, onAuthClick }) {
  const pct = ((step) / (totalSteps)) * 100;
  const { Star, Sparkles, LogIn, Heart } = window.LucideIcons;
    ...
    <header className="sticky top-0 z-30 bg-white/70 backdrop-blur-xl border-b border-slate-200/70">
      <div className="px-10 py-5 flex items-center gap-5">
        ...
        <div className="min-w-[180px] hidden xl:block shrink-0">
          <div className="text-[11px] uppercase tracking-[0.14em] text-slate-400 font-semibold whitespace-nowrap">Leçon en cours</div>
        ...
        <div className="flex-1 min-w-[140px]">
          <div className="flex items-center justify-between mb-1.5">
            <div className="text-[11px] font-semibold text-slate-500 uppercase tracking-wider">Progression</div>
